namespace :disbursements do
  ...
  task calculate: :environment do
    puts "Starting disbursements calculation"
    ...
    curr_day = 0
    days.each do |day|
      puts "Starting disbursements calculation for day #{day}"
      ...
      puts "Finished disbursements calculation for day #{day}"
      puts "<======== #{curr_day}/#{no_of_days} completed ========>"
    end

    puts "Finished disbursements calculation"
  end
